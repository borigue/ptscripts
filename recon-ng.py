...
def main():
    ...
    parser.add_option('-o', help='output to a csv file (append)', dest='filename', type='string', action='store')
    ...
    parser.add_option('-c', metavar='"COMPANY NAME"', help='enumerate company contacts (Contact Enumeration Mode)', dest='company', type='string', action='store')
